...
Description      :web_demo python task
...
def main():
    ...
    gr.ChatInterface(
        predict,
        chatbot=gr.Chatbot(),
        textbox=gr.Textbox(placeholder="我是一款基于DeepSeek训练开发的TCM领域智能机器人，项目归属于天津中医药大学大创（ID:202410033030），请问有什么需要帮助的？", lines=4, scale=9),
        title="TCMChat  ",
        description="Tianjin College Students’ Innovation and Entrepreneurship Training Program (Project No. 202410063030)",
        theme="soft",
